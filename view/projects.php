                                ...
                                <div class="flex flex-col justify-between py-4 px-6 h-48">
                                    ...
                                    <div class="flex justify-between mt-10">
                                        ...
                                        <div class="flex items-center gap-6">
                                            <a href="#" class="editProjectButton" data-project-id="<?php echo $project->getIdpro(); ?>" data-project-name="<?php echo $project->getNompro(); ?>" data-project-description="<?php echo $project->getDescpro(); ?>" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                                            ...
                                            <a href="projects.php?deletepro&idpro=<?php echo $project->getIdpro(); ?>">
