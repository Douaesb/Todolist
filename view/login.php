						...
						<form action="" method="post">
							<div class="divide-y divide-gray-200">
								<div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
									...
									<div class="relative">
										<button name="submit" type="submit" class="bg-yellow-400 text-white rounded-md px-2 py-1">Submit</button>
									</div>
									<p class="text-sm font-light text-gray-500 dark:text-gray-400">
										Don't have an account yet?<a href="register.php" class="font-medium text-yellow-600  hover:underline">Sign up an account </a>
									</p>
								</div>
							</div>
						</form>
