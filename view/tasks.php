        ...
        <div class="flex">
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="flex justify-center w-full mt-20 ml-10 gap-10">
                    ...
                    <button type="submit" class="inline-flex items-center bg-yellow-100 border-2 border-black hover:bg-yellow-200 focus:ring-2 focus:outline-none focus:ring-yellow-300 font-medium rounded-lg text-sm px-3 text-center dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-800">
                                ...
                                <?php foreach ($tasks as $t) : ?>
                                    ...
                                    <div class="flex items-center w-full mt-3 text-xs font-medium text-gray-400">
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-1 leading-none"> <?php echo $t->getDatedeb(); ?>
                                            </span>
                                        </div>
